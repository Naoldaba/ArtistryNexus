        ...
        <FormSection>
          ...
          <Box mt={2} textAlign="center">
            <Typography variant="body2">
              Have an account? <Button variant="text" onClick={() => navigate('/login')} sx={{ color: 'purple' }}>Login</Button>
            </Typography>
          </Box>
          <Box mt={2} textAlign="center">
            <Typography variant="caption">
              By signing up, you agree to our{' '}
              <Button variant="text" sx={{ color: 'purple' }}>Terms of Service</Button> and{' '}
              <Button variant="text" sx={{ color: 'purple' }}>Privacy Policy</Button>.
            </Typography>
          </Box>
        </FormSection>
      </StyledCard>
